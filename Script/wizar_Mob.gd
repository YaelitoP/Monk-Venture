...
func _physics_process(delta: float) -> void:
	...
	for entry_signal in get_incoming_connections():
		if entry_signal.signal_name == "monkdmg":
			dmg_income = entry_signal.signal_name.monkdmg
...
func _on_wizard_monk_dmg(dmg) -> void:
	dmg_income = dmg
